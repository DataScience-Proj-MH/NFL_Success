...
player = pd.read_csv("C:/Users/matth/Documents/GitHub/NFL_Success/final_df.csv")
qb = player[player['Pos'] == 'QB']
...
for year in years:
    player_names = qb.loc[player['Year'] == int(year), 'Player']
    print(player_names)
    i = 1
    i_values = []
    ...
    for i_curr in i_values:
        ...
        driver.implicitly_wait(5)
        try:
            driver.find_element_by_xpath('//*[@id="all_passing"]/div[1]/div/ul/li[2]/span').click()
            driver.implicitly_wait(5)
            driver.find_element_by_xpath('//*[@id="all_passing"]/div[1]/div/ul/li[2]/div/ul/li[4]/button').click()
            table = driver.find_element_by_id('csv_passing')
        except:
...
print(df)
df.to_csv("qb_college_passing.csv")
